...
export function PostSkeleton() {
    return (
      <Card className="w-[340px] md:w-[600px]">
       ...
       <div className="flex  gap-x-3"> <Skeleton className="h-12 w-12 rounded-full" />
      <div className="space-y-2">
        ...
        <CardContent className='flex-col'>
          <Skeleton className=" mt-2 h-[450px]" />
        </CardContent>
      </Card>
    );
  }
    ...
    return (
      <div className="grid grid-cols-1  md:grid-cols-2 lg:grid-cols-3 gap-x-5 gap-y-8 mb-20">
        ...
        <div className="relative flex flex-col justify-center overflow-hidden">
            ...
            <div className="group relative m-0 flex h-56 w-56 rounded-xl shadow-xl ring-gray-900/5 sm:mx-auto sm:max-w-lg">
                <div className="z-10 h-full w-full overflow-hidden rounded-xl border border-gray-200 opacity-80 transition duration-300 ease-in-out">
                    <Skeleton className="h-full w-full animate-pulse" />
                </div>
                <div className="absolute bottom-0 z-20 m-0 pb-2 ps-2">
